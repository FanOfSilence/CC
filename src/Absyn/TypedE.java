...
public class TypedE extends Expr {
  public final Type type_;
  public final Expr expr_;
  public TypedE(Type p1, Expr p2) { type_ = p1; expr_ = p2; }

  public <R,A> R accept(Expr.Visitor<R,A> v, A arg) throws TypeException { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof TypedE) {
      TypedE x = (TypedE)o;
